...
class PDMScorer:
    ...
    def _aggregate_scores(self) -> npt.NDArray[np.float64]:
        ...
        # self._multi_metrics[MultiMetricIndex.DRIVABLE_AREA] = np.ones_like(self._multi_metrics[MultiMetricIndex.DRIVABLE_AREA])
        ...
        # print("PROGRESS")
        # print(self._weighted_metrics[WeightedMetricIndex.PROGRESS])
        # print("TTC")
        # print(self._weighted_metrics[WeightedMetricIndex.TTC])
        # print("COMFORTABLE")
        # print(self._weighted_metrics[WeightedMetricIndex.COMFORTABLE])
        # print("LANE_FOLLOWING")
        # print(self._weighted_metrics[WeightedMetricIndex.LANE_FOLLOWING])
        # print("PROXIMITY")
        # print(self._weighted_metrics[WeightedMetricIndex.PROXIMITY])
        ...
        final_scores = weighted_metric_scores
