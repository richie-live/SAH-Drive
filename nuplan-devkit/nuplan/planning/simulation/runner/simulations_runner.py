...
class SimulationRunner(AbstractRunner):
    ...
    def run(self) -> RunnerReport:
        ...
        # del self.planner._model_loader # Avoid memory explosion
        del self.planner._planner 


        # # Save runtime to csv file
        # with open('/home/fyq/Downloads/execution_times.csv', 'w', newline='') as file:
        #     writer = csv.writer(file)
        #     writer.writerow(['Run Number', 'Execution Time (seconds)'])  # Write to the table header
        #     writer.writerows(self.planner._execution_times)  
        # print("Run time has been saved to the 'execution_times.csv' file")
        # with open('/home/fyq/Downloads/planner.csv', 'w', newline='') as file:
        #     writer = csv.writer(file)
        #     writer.writerow(['Run Number', 'planner']) 
        #     writer.writerows(self.planner._planner_types)  
        # print("Run time has been saved to the 'planner.csv' file")
